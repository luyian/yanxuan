/**
 * <multiple-select ng-model="selected" suggestions-arr="optionList" object-property="name" close-after-selected="true"></multiple-select>
 *
 **/

angular.module("templates", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("multiple-select-tpl.html","<div class=\"ng-ms form-item-container\">\n" +
        "    <ul class=\"list-inline\">\n" +
        "        <li ng-repeat=\"item in modelArr track by $index\">\n" +
        "\t\t\t<span ng-if=\"objectProperty == undefined || objectProperty == ''\">\n" +
        "\t\t\t\t{{item}} \n" +
        "                <span class=\"remove\" ng-click=\"removeAddedValues(item)\"aria-hidden=\"true\">&times;</span>&nbsp;\n" +
        "\t\t\t</span>\n" +
        "            <span ng-if=\"objectProperty != undefined && objectProperty != ''\">\n" +
        "\t\t\t\t{{item[objectProperty]}} \n" +
        "                <span class=\"remove\" ng-click=\"removeAddedValues(item)\" aria-hidden=\"true\">&times;</span>&nbsp;\n" +
...
(function () {
    ...
    angular.module('multipleSelect').directive('multipleSelect', [
        '$filter',
        '$http',
